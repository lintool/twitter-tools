...
public class ExtractSubcollectionUserInteractions {
  private static final Logger LOG = Logger.getLogger(ExtractSubcollectionUserInteractions.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    while ((status = stream.next()) != null) {
      ...
      if (userids.contains(status.getInReplyToUserId())) {
        cnt++;
        LOG.info("Reply: " + status.getScreenname() + "\t" + status.getText().replaceAll("[\\n\\r]+", " "));
